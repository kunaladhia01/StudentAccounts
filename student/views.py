...
def preorder(request, event_id):
	...
	if request.method == 'POST':
		...
		form = OrderForm()
        paypal_dict = {
                    "business": "receiver_email@example.com",               #Email ID of ClassFund
                    "amount": str(cost),                                                            #Amount of Transaction
                    "item_name": event_name,                                            #Name of Lunch
                    "invoice": "unique-invoice-id",                                         #
                    "notify_url": "https://www.example.com",# + reverse('paypal-ipn'),  #Website to send IPN message
                    "return_url": "https://www.example.com/your-return-location/",
                    "cancel_return": "https://www.adhias.com/student/order/",
                    "custom": "Thank you for your purchase!",  # Custom command to correlate to some function later (optional)
                    "shipping": "0.25",
                    "discount_amount_cart": "0.25",
                    "shopping_url": "https://www.adhias.com/student/order/",
                    "no_shipping": "1",
                    "return": "www.adhias.com/student/confirmorder/"    #MAKE NEW PAGE
                }

                # Create the instance.
        formpaypal = PayPalPaymentsForm(initial=paypal_dict)
        #context = {"formpaypal": formpaypal}
        work = {'formpay': formpaypal, 'event':u}                    
	# What you want the button to do.
	return render(request, 'student/event.html', {'work':work})
